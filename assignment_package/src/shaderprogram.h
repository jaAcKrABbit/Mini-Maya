...
public:
    ...
    //pass a vector of matrices to the shader
    void setOverallTransformationMatrices(const std::vector<glm::mat4> &transforms);
    void setBindMatrices(const std::vector<glm::mat4> &bindMatrices);
